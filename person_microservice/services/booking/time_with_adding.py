...
def time_adding(start_time, duration, coefficient=1):
    ...
    add_time = timedelta(hours=duration.hour, minutes=duration.minute, seconds=duration.second)
...
def get_start_time_appointments(start_time, finish_time, duration):
    count_appointment = (timedelta(hours=finish_time.hour, minutes=finish_time.minute, seconds=finish_time.second)\
    ...
    return [time_adding(start_time, duration, coefficient) for coefficient in range(count_appointment)]
