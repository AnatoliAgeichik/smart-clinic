...
def get_all_notification(user_id):
    ...
    return Response(notifications_schema.dumps(notifications), status=200, mimetype="application/json")
...
@token_required
@notification_view.route("user/<user_id>/received/<notification_id>", methods=["Delete"])
